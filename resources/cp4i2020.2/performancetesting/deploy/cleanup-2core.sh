...
oc delete configmap mqperf2mqsc -n $TARGET_NAMESPACE
oc delete pvc data-mqperf2core-ibm-mq-0 -n $TARGET_NAMESPACE
oc delete pvc data-mqperf2core-ibm-mq-1 -n $TARGET_NAMESPACE
oc delete pvc data-mqperf2core-ibm-mq-2 -n $TARGET_NAMESPACE
